...
Following function retrieves articles top 100 most downloaded articles related to COVID-19:

```{r}
res <- rxivist_search(search_phrase = "COVID-19", from = "alltime", sortby = "downloads", limit = 100)
dplyr::glimpse(res)
```
...
Returns information about the number of articles index in rxivist.
